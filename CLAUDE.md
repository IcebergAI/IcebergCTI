...
src/iceberg/
  ...
  api/             # JSON routers: notebooks (incl. imports/taxii + imports/misp), reports, requirements, feed, feedback, account, preview, tags, search, attack, audience, audience-policy (admin rule sets + publisher recipient preview), ai, taxii
