...
src/iceberg/
  ...
  services/        # users, notebooks, lifecycle, citations/rendering (reports), requirements, attachments, figures, diamond, product_html (shared report-HTML assembler), dissemination, email, tags, relationships, search
